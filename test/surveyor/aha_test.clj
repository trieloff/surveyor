(ns surveyor.aha-test
  (:require [clojure.test :refer :all]
            [surveyor.aha :refer :all]))

(def feature25 {"release"
...
(count (flatten multifeatures))

(deftest outcome-test
  (testing "Filter for outcome"
    (is (= true (has-outcome? feature25)))))

(get feature25 "reference_num")

(run-tests)
(has-outcome? feature25)
